{
  description = "ShellIntegration.jl - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 ShellIntegration.jl development environment"
            echo "Language: mixed"
            echo ""
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P ShellIntegration.jl.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/ShellIntegration.jl $out/bin/  # Rust
            # cp bin/ShellIntegration.jl $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/ShellIntegration.jl";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-ShellIntegration.jl" {
