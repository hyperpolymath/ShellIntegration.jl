...
# Justfile for ShellIntegration.jl
...
doctor:
    @echo "Running diagnostics for ShellIntegration.jl..."
...
help-me:
    @echo "=== ShellIntegration.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/ShellIntegration.jl/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: ShellIntegration.jl"
