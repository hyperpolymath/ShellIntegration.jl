...
= Shellintegration.Jl — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/ShellIntegration.jl
cd ShellIntegration.jl
...
* https://github.com/hyperpolymath/ShellIntegration.jl/issues — report bugs
